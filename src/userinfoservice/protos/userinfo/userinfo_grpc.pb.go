...
func (c *userInfoServiceClient) GetUserInfo(ctx context.Context, in *GetUserInfoRequest, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
...
func (UnimplementedUserInfoServiceServer) GetUserInfo(context.Context, *GetUserInfoRequest) (*UserInfo, error) {
